...
const REQUIRED_URL =
  "https://mp.weixin.qq.com/s?__biz=MzU1NTY0NTgyMA==&mid=2247493313&idx=1&sn=fd01d9a5ac026d1586aacb8b284cb106&chksm=fa11d555365b2a8b4b4ab15604f57665a89033dfbedea35d00b5e82d5de9dd457b5c823fa07c#rd";

const Q = {
  engine: "vLLM SGLang",
  pd: "PD 分离 Prefill Decode",
  sched: "Kueue Volcano Gang Scheduling",
  gpu: "GPU 算力成本 MFU",
  ascend: "昇腾 国产卡 Day0",
  bench: "模型评测 benchmark 独立复现",
};

/** @type {Array<{title: string, account: string, publishedLabel: string, summary: string, query: string, channel?: string, hasDirectLink?: boolean, url?: string}>} */
const rows = [
  {
    title: "SGLang 和 vLLM：大模型背后的“推理引擎”",
    account: "水金聊投资",
  ...
  {
    title: "同一张 H100 上的 vLLM 与 SGLang：吞吐、尾延迟、前缀命中",
    account: "Serving 研究室",
    publishedLabel: "1小时前",
    query: Q.engine,
    summary:
  ...
  {
    title: "PagedAttention 之后：连续批处理还在还债",
    account: "训练推理手记",
    publishedLabel: "2小时前",
    query: Q.engine,
    summary:
  ...
  {
    title: "从 FasterTransformer 到 vLLM：开源 Serving 五年",
    account: "开源前线",
    publishedLabel: "昨天",
    query: Q.engine,
    summary:
  ...
  {
    title: "SGLang 结构化输出：Constrained Decoding 落地笔记",
    account: "模型前线",
    publishedLabel: "2天前",
    query: Q.engine,
    summary:
  ...
  {
    title: "多 LoRA 同时在线：vLLM 的 adapter 调度",
    account: "云原生指北",
    publishedLabel: "2天前",
    query: Q.engine,
    hasDirectLink: false,
  ...
  {
    title: "本地 4090 跑通 SGLang：一份不掺水的延迟表",
    account: "硅星人Pro",
    publishedLabel: "3天前",
    query: Q.engine,
    summary:
  ...
  {
    title: "开源推理引擎的版本地狱：CUDA、Torch、驱动",
    account: "K8s 深夜食堂",
    publishedLabel: "5天前",
    query: Q.engine,
    hasDirectLink: false,
  ...
  {
    title: "从单卡 Demo 到多机 Serving：SGLang 集群笔记",
    account: "云原生指北",
    publishedLabel: "一周前",
    query: Q.engine,
    hasDirectLink: false,
  ...
  {
    title: "Disaggregated Serving 综述：论文到工单",
    account: "开源前线",
    publishedLabel: "昨天",
    query: Q.pd,
    summary:
  ...
  {
    title: "vLLM / SGLang 生态里的 PD 插件现实",
    account: "云原生指北",
    publishedLabel: "2天前",
    query: Q.pd,
    summary:
  ...
  {
    title: "KV Cache 传输协议：从私有 CUDA IPC 到标准化",
    account: "国产芯观察",
    publishedLabel: "3天前",
    query: Q.pd,
    summary:
  ...
  {
    title: "Kueue 入门：把 GPU Job 当成配额，而不是 Pod",
    account: "K8s 深夜食堂",
    publishedLabel: "1小时前",
    query: Q.sched,
    summary:
  ...
  {
    title: "Volcano 还在吗：Gang Scheduling 的老兵视角",
    account: "调度器札记",
    publishedLabel: "2小时前",
    query: Q.sched,
    summary:
  ...
  {
    title: "Gang Scheduling 失败的典型现场：差一张卡",
    account: "训练推理手记",
    publishedLabel: "3小时前",
    query: Q.sched,
    hasDirectLink: false,
  ...
  {
    title: "Local Queue 和 Cluster Queue：多租户的最小语言",
    account: "Infra 周报",
    publishedLabel: "昨天",
    query: Q.sched,
    summary:
  ...
  {
    title: "Kubernetes 原生调度对 AI 作业还缺什么",
    account: "开源前线",
    publishedLabel: "2天前",
    query: Q.sched,
    summary:
  ...
  {
    title: "一张 Volcano Queue 配置引发的血案",
    account: "K8s 深夜食堂",
    publishedLabel: "3天前",
    query: Q.sched,
    summary:
  ...
  {
    title: "Gang 与弹性训练：部分 worker 先走可以吗",
    account: "模型前线",
    publishedLabel: "3天前",
    query: Q.sched,
    hasDirectLink: false,
  ...
  {
    title: "Kueue 1.x 之后：All-or-Nothing 与拓扑的距离",
    account: "调度器札记",
    publishedLabel: "5天前",
    query: Q.sched,
    summary:
  ...
  {
    title: "Coscheduling 插件和 Volcano 选哪个",
    account: "云原生指北",
    publishedLabel: "一周前",
    query: Q.sched,
    summary:
  ...
  {
    title: "算力成本的三层：卡时、token、合格 token",
    account: "算力观察",
    publishedLabel: "2小时前",
    query: Q.gpu,
    summary:
  ...
  {
    title: "小 batch 的良心：产品要实时，财务要 MFU",
    account: "Serving 研究室",
    publishedLabel: "2天前",
    query: Q.gpu,
    hasDirectLink: false,
  ...
  {
    title: "CANN 与 PyTorch：适配层的厚度决定 Day0 质量",
    account: "开源前线",
    publishedLabel: "2小时前",
    query: Q.ascend,
    summary:
  ...
  {
    title: "K8s Device Plugin 之后：昇腾资源怎么切",
    account: "K8s 深夜食堂",
    publishedLabel: "5天前",
    query: Q.ascend,
    summary:
  ...
  {
    title: "MMLU、GSM8K、LiveCodeBench：名字相同，题可能不同",
    account: "模型前线",
    publishedLabel: "2小时前",
    query: Q.bench,
    summary:
  ...
  {
    title: "解码参数是隐藏超参：temperature 0 也不是中立",
    account: "训练推理手记",
    publishedLabel: "3小时前",
    query: Q.bench,
    hasDirectLink: false,
